...
I P N
CECyT No.9
Quantum X Post Search
-->

<!-- select * from post where post_message like '%a' or post_message like '%a%' or post_message like 'a%'; -->
                ...
                <div>
                    <%
                        ...
                        try {
                            ...
                            String keyWord = request.getParameter("searchP");
                            String strQry1 = "select*from post where post_content like '%"+keyWord+"' or post_content like '%"+keyWord+"%' or post_content like '"+keyWord+"%' and approved = 1 order by post_date desc; ";
                            ResultSet rs = null;
